const sharedCommandCatalog = {
  ...
  "fusão": {
    name: 'fusão',
    category: 'pokemon',
    summary: 'Abre a loja de fusão para craft com fragmentos',
    slackUsage: '`!fusão` / `!fusao`',
    discordDescription: 'Abre a loja de fusão',
  },
  reroll: {
    name: 'reroll',
    category: 'pokemon',
    summary: 'Rerolla os IVs de um Pokémon usando Roleta Mágica',
    slackUsage: '`!reroll <id>`',
    discordDescription: 'Rerolla IVs de um Pokémon',
  },
  transform: {
    name: 'transform',
    category: 'pokemon',
    summary: 'Transforma um Pokémon em SHINE normal usando Prisma',
  ...
  transformprime: {
    name: 'transformprime',
    category: 'pokemon',
    summary: 'Transforma um Pokémon em SHINE PRIME usando Prisma PRIME',
    slackUsage: '`!transformprime <id>`',
    discordDescription: 'Transforma um Pokémon em SHINE PRIME',
  },
  healstation: {
    name: 'healstation',
    category: 'pokemon',
