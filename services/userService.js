...
async function getUser(slackUserId) {
  ...
  const { data, error } = await supabase
    .from("users")
    .select("slack_user_id, gold, pokemon_essence, account_xp, account_level, current_energy, max_energy, last_energy_update, created_at, last_capture_at, last_claim_at")
